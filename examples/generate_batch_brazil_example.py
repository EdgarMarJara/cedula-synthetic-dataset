"""Ejemplo: generar un batch de cédulas brasileñas sintéticas con metadatos en CSV."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Genera un dataset de cédulas brasileñas sintéticas")
    parser.add_argument("--num-samples", type=int, default=100, help="Cantidad de cédulas a generar")
    parser.add_argument("--output-dir", type=str, default="synthetic_dataset_br", help="Directorio de salida")
    ...
    generator = BrazilIDGenerator(output_dir=args.output_dir, seed=args.seed)
